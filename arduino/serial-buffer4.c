//TODO
//Add a 3colorsled -> 3 slider
//
//DONE
//Transmision on serial only if needed. ->OK
//
//
...
void loop()
{
  ...
  //print the int value store in myCharvalue
  //Serial.println(myCharValue);
  if (myString!=myStringBefore)
  {
    if (axes=="x")
    {
      if (myIntValue<=15) {
